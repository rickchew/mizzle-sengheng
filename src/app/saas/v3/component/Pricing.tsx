          ...
          <Col lg={6}>
            <Card className="bg-light overflow-hidden p-0 h-100">
              <figure className="position-absolute top-0 end-0 mt-n6 me-n6">
                <svg className="fill-primary opacity-2" width="220px" height="209px" viewBox="0 0 220 209">
              ...
              <CardBody className="position-relative p-sm-6 pb-lg-0">
                <h2 className="mb-4">Anywhere, Any Time, Any Platform</h2>
                <p className="heading-color mb-4">Download the app for free and get access to accurate plant diagnoses with no extra charges.</p>
              ...
              <CardFooter className="bg-transparent p-0">
                <Image src={saasScreen} className="ms-5" alt="" />
              </CardFooter>
            </Card>
          </Col>
          ...
          <Col lg={6}>
            <Card className="bg-dark overflow-hidden p-sm-4 h-100" data-bs-theme="dark">
              <div className="position-absolute end-0 bottom-0 mb-n3 me-n3">
                <Image src={patternImg} className="opacity-1" alt="" />
              </div>

              <CardHeader className="text-center bg-transparent position-relative">
                <Image src={logoIcon} className="mb-4" alt="logo-icon" />
              ...
              <CardBody className="bg-light border rounded mx-2 mx-sm-4 position-relative">
              ...
              <CardFooter className="card-footer text-center bg-transparent position-relative mt-3">
                <div className="mb-4 heading-color">
                  <span className="h2">{currency}299</span> /month
                </div>

                <Link href="" className="btn btn-lg btn-primary w-100 mb-0">
                  Get 1 year access
                </Link>
              </CardFooter>
            </Card>
