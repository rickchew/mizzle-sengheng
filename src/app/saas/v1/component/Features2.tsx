...
import { BsBoxes, BsDiagram3, BsPeople, BsShieldCheck } from 'react-icons/bs'
            ...
            <Row className="g-4 mb-4 mb-sm-5">
              <Col sm={6}>
                <div className="d-flex mb-4 mb-sm-5">
                  <div className="icon-md flex-shrink-0 text-primary bg-primary bg-opacity-10 rounded-circle flex-centered">
