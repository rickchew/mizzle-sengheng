          ...
          <Col lg={10} className=" mx-auto">
            <Row className="g-4 align-items-center mb-6">
              ...
              <Col md={6}>
                ...
                <h6>‣ Customized pipelines for industrial use</h6>
                <h6>‣ Valve systems for fluid control and regulation</h6>
              </Col>
            </Row>
            <Row className="g-4 align-items-center mb-6">
              <Col md={6} className="order-2">
                ...
                <h6>‣ Pre-fabricated modular units for industrial equipment</h6>
                <h6>‣ Designed for easy transportation and installation</h6>
              </Col>
            ...
            <Row className="g-4 align-items-center">
              ...
              <Col md={6}>
                ...
                <h6>‣ Handrails for safety and industrial applications</h6>
                <h6>‣ Structural extensions for existing frameworks</h6>
                <h6>‣ Custom steel platforms for operational efficiency</h6>
              </Col>
            </Row>
            <Row className="g-4 align-items-center mb-6">
              <Col md={6} className="order-2">
