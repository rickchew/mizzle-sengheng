...
export const services: ServiceType[] = [
  {
    title: 'Integrated Transport Services',
    description: "Safe and efficient transport solutions supporting land and marine operations.",
    icon: businessIcon,
  },
  {
    title: 'Cargo & Freight Management',
    description: 'Professional handling and forwarding services to keep supply chains moving.',
    icon: strategicIcon,
  },
  {
    title: 'Operational Logistics Support',
    description: "Coordinated logistics solutions tailored to complex operational requirements.",
    icon: marketingIcon,
  },
  // {
  //   title: 'Land & Sea Transport',
