...
import decoration2 from '@/assets/images/elements/saas-decoration/decoration-10.png'
import decoration16 from '@/assets/images/elements/saas-decoration/26.png'
import decoration17 from '@/assets/images/elements/saas-decoration/28.png'
      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col lg={6} className="z-index-2 mb-6 mb-lg-0 order-1 order-lg-2">
            <h2 className="mb-4 mb-lg-5">Essential Services for Offshore Operations</h2>
