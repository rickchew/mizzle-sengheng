    ...
    <section className="pb-0">
      <Container>
        <div className="inner-container text-center mb-4 mb-sm-6">
          <span className="heading-color bg-light small rounded-3 px-3 py-2">💵 Transparent pricing packages</span>
              ...
              <Row className="text-center text-sm-start">
                <Col sm={6}>
                  <div className="d-flex justify-content-between mb-4 mb-sm-0">
                    <div>
                      <figure>
                        <svg width="120px" height="156px" viewBox="0 0 120 156" xmlSpace="preserve">
                          <path
                      ...
                      <div className="badge bg-dark text-white mb-3">Boss mode</div>
                      <h6 className="mb-3">
                        
                        <span className="display-2">{currency}59</span> /month
                      </h6>
                      <p className="mb-0">The all-in-one solution for businesses that want to succeed online.</p>
                    </div>
          ...
          <Col lg={4} className="ms-auto mt-4 mt-lg-0">
            <Card className="bg-primary rounded h-100 overflow-hidden p-4">
              <div className="position-absolute top-0 end-0 mt-n3 me-n4">
                <Image src={pattern2} className="opacity-2 h-200px" alt="" />
              </div>

              <CardBody className="bg-transparent position-relative p-0">
                <div className="badge bg-dark text-white">Enterprise</div>
                <h4 className="text-white mb-0 mt-3">Custom pricing plan</h4>
              </CardBody>

              <CardFooter className="bg-transparent d-grid text-center p-0 mt-8">
                <Link href="/contact/v1" className="btn btn-white">
                  Contact Sales
                </Link>
                <p className="mb-0 text-white">Get personalized demo and custom plan</p>
              </CardFooter>
            </Card>
          </Col>
        </Row>
