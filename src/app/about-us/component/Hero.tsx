      ...
      <Container>
        <Row>
          <Col xl={10} className="text-center mx-auto">
            ...
            <h1 className="mb-4">Building on Trust, Driven by Marine and Engineering Expertise</h1>
            ...
            <Row className="g-4 mt-5 mx-auto align-items-end">
              <Col md={5} className="position-relative">
                <Image src={about22} className="rounded mb-4" alt="about-img" />
              ...
              <Col md={7} className="position-relative mb-n4">
                ...
                <Card className="card-body bg-dark text-start z-index-2 w-75 p-5 mb-4">
                  <span className="text-white">Moving Towards Success - </span>
                  <h4 className="text-white fw-light mb-0 mt-3">Providing innovative, integrated services in maritime transport, shipbuilding, engineering, and offshore logistics.</h4>
                </Card>
