        ...
        <div className="container">
          <Row className=" g-4 align-items-center">
            <div className="col-lg-6 position-relative order-2">
              ...
              <div className="bg-white shadow rounded d-flex align-items-center px-3 py-2 position-absolute bottom-0 end-0 mb-4 me-5">
                <div className="avatar avatar-sm flex-shrink-0 me-2">
              ...
              <Row className=" pe-md-6">
                <div className="col-6 position-relative">
                  ...
                  <Image src={about10} className="rounded-pill" alt="about-img" />
                </div>
                <div className="col-6 mt-8">
                  <Image src={about11} className="rounded-pill" alt="about-img" />
                </div>
              </Row>
            </div>
