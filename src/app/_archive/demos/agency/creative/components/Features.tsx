import { Accordion, AccordionBody, AccordionHeader, AccordionItem, Card, Col, Container, ProgressBar, Row } from 'react-bootstrap'
      ...
      <Container className="mt-9">
        <Row className="align-items-start">
          <Col md={6} xl={5} className="position-relative">
            ...
            <Image src={about5} className="rounded" alt="about-img" />
          </Col>
          ...
          <Col md={6} className="position-relative ms-auto mt-5 mt-md-0">
            ...
            <Accordion defaultActiveKey="0" className="accordion-icon accordion-icon-start accordion-bg-light">
              {features.map((feature, idx) => (
                <AccordionItem eventKey={idx.toString()} className="mb-3" key={idx}>
                  <AccordionHeader as={'p'} className="font-base">
                    <span className="ps-5 fw-semibold">{feature.title}</span>
                  </AccordionHeader>
